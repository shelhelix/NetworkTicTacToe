...
namespace Shapes {
	...
	public abstract class ShapeRenderer : MonoBehaviour {
		...
		[SerializeField] [ShapesColorField( true )] protected Color color = Color.white;
		public virtual Color Color {
			get => color;
			set => SetColorNow( ShapesMaterialUtils.propColor, color = value );
		}
		[SerializeField] protected DetailLevel detailLevel = DetailLevel.Medium;
		...
		public static readonly byte DEFAULT_STENCIL_MASK = 255; // read & write
		...
		protected virtual Mesh GetInitialMeshAsset() => ShapesMeshUtils.QuadMesh[HasDetailLevels ? (int)DetailLevel.Medium : 0];
