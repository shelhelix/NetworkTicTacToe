...
namespace Shapes {
	...
	class IMDrawer : IDisposable {
		...
		public IMDrawer( MetaMpb metaMpb, Material sourceMat, Mesh sourceMesh, Vector3 pos, Quaternion rot, int submesh = 0, bool cachedTMP = false ) : this( metaMpb, sourceMat, sourceMesh, GetDrawingMatrix( pos, rot ), submesh, cachedTMP ) => _ = 0;
